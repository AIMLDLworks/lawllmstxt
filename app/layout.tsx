...
export const metadata: Metadata = {
  title: "LawLLMTxt — the llms.txt directory for U.S. law firms",
  description:
        ...
        <header className="border-b border-slate-200 bg-white">
          <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
            <Link href="/" className="text-xl font-bold text-brand">
              Law<span className="text-brand-accent">LLMtxt</span>
            </Link>
        ...
        <footer className="mt-16 border-t border-slate-200 bg-white">
          <div className="mx-auto max-w-5xl px-4 py-8 text-xs text-slate-500">
            ...
            <p className="leading-relaxed">
              LawLLMTxt is a public data directory of llms.txt files. It is not
